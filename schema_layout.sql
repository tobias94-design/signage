...
ALTER TABLE dispositivi
    ...
    ADD COLUMN IF NOT EXISTS hw_type         ENUM('pi','android','brightsign','pc','altro') DEFAULT 'altro',
    ADD COLUMN IF NOT EXISTS layer_overrides JSON DEFAULT NULL,
    ADD CONSTRAINT fk_dispositivi_template
